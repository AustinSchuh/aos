...
// non-ASCII characters fails the ABSL_PCHECK below.  Supporting them means
// carrying UTF-16 (via _wopen, or std::filesystem::path) through the logging
// code generally, not just converting at this one call site, so it isn't worth
// doing piecemeal here.
